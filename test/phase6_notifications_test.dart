...
void main() {
  ...
  test('midday notification is suppressed when relevant trackers are already logged',
      () {
  ...
  test('day-end notification opens batch when more than one tracker remains', () {
  ...
  test('missed midday notifications are dropped instead of queued for tomorrow', () {
    final breakfast = _tracker(
      uid: 'tracker-breakfast',
      promptTimes: <String>['08:30'],
    );
  ...
  test('notification planner never emits more than the midday and day-end pair', () {
    final breakfast = _tracker(
      uid: 'tracker-breakfast',
      promptTimes: <String>['08:30'],
    );
