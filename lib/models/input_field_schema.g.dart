...
part of 'input_field_schema.dart';
...
const InputFieldSchemaSchema = Schema(
  name: r'InputFieldSchema',
  id: 2877290208419321337,
  properties: {
  ...
  estimateSize: _inputFieldSchemaEstimateSize,
  serialize: _inputFieldSchemaSerialize,
  deserialize: _inputFieldSchemaDeserialize,
  deserializeProp: _inputFieldSchemaDeserializeProp,
);

int _inputFieldSchemaEstimateSize(
  InputFieldSchema object,
  List<int> offsets,
...
void _inputFieldSchemaSerialize(
  InputFieldSchema object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
InputFieldSchema _inputFieldSchemaDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = InputFieldSchema();
...
P _inputFieldSchemaDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension InputFieldSchemaQueryFilter
    on QueryBuilder<InputFieldSchema, InputFieldSchema, QFilterCondition> {
  QueryBuilder<InputFieldSchema, InputFieldSchema, QAfterFilterCondition>
      configJsonIsNull() {
...
extension InputFieldSchemaQueryObject
    on QueryBuilder<InputFieldSchema, InputFieldSchema, QFilterCondition> {}
