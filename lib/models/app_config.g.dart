...
extension AppConfigQueryWhereSort
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterWhere> anyIsarId() {
...
extension AppConfigQueryWhere
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterWhereClause> isarIdEqualTo(
    Id isarId,
  ) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterWhereClause> isarIdNotEqualTo(
    Id isarId,
  ) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterWhereClause> isarIdGreaterThan(
    Id isarId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterWhereClause> isarIdLessThan(
    Id isarId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterWhereClause> isarIdBetween(
    Id lowerIsarId,
    Id upperIsarId, {
...
extension AppConfigQueryFilter
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterFilterCondition> isarIdEqualTo(
    Id value,
  ) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterFilterCondition> isarIdGreaterThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterFilterCondition> isarIdLessThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterFilterCondition> isarIdBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension AppConfigQuerySortThenBy
  ...
  QueryBuilder<AppConfig, AppConfig, QAfterSortBy> thenByIsarId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isarId', Sort.asc);
    });
  }

  QueryBuilder<AppConfig, AppConfig, QAfterSortBy> thenByIsarIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AppConfigQueryProperty
  ...
  QueryBuilder<AppConfig, int, QQueryOperations> isarIdProperty() {
    return QueryBuilder.apply(this, (query) {
