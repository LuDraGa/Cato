...
const ceramic = CatoSoundPack(
  ...
  save: SoundAsset(
    ...
    description:
        'Single ceramic tap — like setting down a cup on a saucer. '
  ...
  complete: SoundAsset(
    ...
    description:
        'Deeper ceramic bowl tap — rounder, more resonant than save. '
  ...
  milestone: SoundAsset(
    ...
    description:
        'Two ceramic taps in quick succession (low then high), '
  ...
  tick: SoundAsset(
    ...
    description:
        'Tiny porcelain click — like a ceramic bead dropping. '
  ...
  delete: SoundAsset(
    ...
    description:
        'Soft scrape — like sliding a ceramic piece across a surface. '
...
const paper = CatoSoundPack(
  ...
  save: SoundAsset(
    ...
    description:
        'Single page turn — not a full book flip, just one leaf '
  ...
  complete: SoundAsset(
    ...
    description:
        'Soft book closing — a journal shutting with gentle finality. '
  ...
  milestone: SoundAsset(
    ...
    description:
        'Paper stamp impression — like a seal pressed into paper. '
  ...
  tick: SoundAsset(
    ...
    description:
        'Pencil mark — single graphite stroke on paper. '
        'Dry, textured, ~40ms.',
    isPlaceholder: true, // TODO: source asset
  ),
  delete: SoundAsset(
    ...
    description:
        'Paper tear — gentle, not violent. Like tearing a perforated '
...
const water = CatoSoundPack(
  ...
  save: SoundAsset(
    ...
    description:
        'Single water drop into a still pool — clear, round, '
  ...
  complete: SoundAsset(
    ...
    description:
        'Two drops in sequence (different pitches) — like the last '
  ...
  milestone: SoundAsset(
    ...
    description:
        'Gentle stream moment — a brief 500ms sample of water '
  ...
  tick: SoundAsset(
    ...
    description:
        'Tiny bubble pop — almost subliminal, very short. '
  ...
  delete: SoundAsset(
    ...
    description:
        'Water draining — gentle, receding, like the last '
...
const wood = CatoSoundPack(
  ...
  save: SoundAsset(
    ...
    description:
        'Bamboo knock — hollow, warm, like tapping a bamboo tube '
  ...
  complete: SoundAsset(
    ...
    description:
        'Wooden box closing — the satisfying click of a '
  ...
  milestone: SoundAsset(
    ...
    description:
        'Temple woodblock (mokugyo) — single strike, resonant. '
  ...
  tick: SoundAsset(
    ...
    description:
        'Chopstick tap — two thin wooden sticks clicking together. '
        'Dry, precise, ~40ms.',
    isPlaceholder: true, // TODO: source asset
  ),
  delete: SoundAsset(
    ...
    description:
        'Drawer sliding — a wooden drawer pushed gently closed. '
...
const bell = CatoSoundPack(
  ...
  save: SoundAsset(
    ...
    description:
        'Small singing bowl — single soft strike with a mallet. '
  ...
  complete: SoundAsset(
    ...
    description:
        'Medium singing bowl — deeper, richer than save. '
  ...
  milestone: SoundAsset(
    ...
    description:
        'Temple bell (bonshō style) — single deep strike, '
  ...
  tick: SoundAsset(
    ...
    description:
        'Tiny wind chime — single high note from a small '
  ...
  delete: SoundAsset(
    ...
    description:
        'Dampened bell — a chime immediately muted by a palm. '
...
const glass = CatoSoundPack(
  ...
  save: SoundAsset(
    ...
    description:
        'Wine glass rim tap — gentle finger tap on crystal. '
  ...
  complete: SoundAsset(
    ...
    description:
        'Two glasses touching — a soft toast clink. '
  ...
  milestone: SoundAsset(
    ...
    description:
        'Crystal bowl singing — a wet finger circling a crystal rim. '
  ...
  tick: SoundAsset(
    ...
    description:
        'Glass marble click — two small glass beads touching. '
        'Tiny, precise, ~30ms.',
    isPlaceholder: true, // TODO: source asset
  ),
  delete: SoundAsset(
    ...
    description:
        'Glass bead rolling — a small marble rolling across a '
...
const textile = CatoSoundPack(
  ...
  save: SoundAsset(
    ...
    description:
        'Cloth fold — a single fold of quality linen or cotton. '
  ...
  complete: SoundAsset(
    ...
    description:
        'Blanket settling — the sound of a throw blanket landing '
  ...
  milestone: SoundAsset(
    ...
    description:
        'Ribbon pull — a satin ribbon being pulled through fabric. '
  ...
  tick: SoundAsset(
    ...
    description:
        'Thread snap — a single thread being plucked or snapped. '
  ...
  delete: SoundAsset(
    ...
    description:
        'Velcro whisper — a very gentle, very short velcro separation. '
